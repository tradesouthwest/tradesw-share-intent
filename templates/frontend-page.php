...
/**
 * Array contains the content.
 * @param string $url   uri of post, to share.
 * @param string $title Title of post.
 * @param string $tsi   Form greeting.
 * 
 * @since 1.0
 * @return HTML loop
 */
        ...
        <?php foreach ( $platforms as $key => $platform ) : ?>
            <li class="share-<?php echo esc_attr( $key ); ?>">
                <a href="<?php echo esc_url( $platform['url'] ); ?>" 
                   ...
                   class="tsw-share-btn">
                    <?php echo $platform['label']; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                    ?>
                </a>
            </li>
        <?php endforeach; ?>
